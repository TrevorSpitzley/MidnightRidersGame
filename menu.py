...
def main():
    ...
    johnSKLogo = pygame.image.load('./introScreens/johnSK.png').convert()
    ...
    introScreens = [midnightRidersLogo, bigTrevLogo, johnSKLogo]
    ...
    #setup bonus show offy stuff, can totally ignore
    engine.setupBonusImages()
